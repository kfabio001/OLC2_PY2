...
from Optimizador.OptimizadorAST.Etiqueta import Etiqueta
from Optimizador.OptimizadorAST.GoTo import GoTo
from Optimizador.OptimizadorAST.Simbolo import TIPO_DATO as Tipo
from Optimizador.OptimizadorValorImplicito.Operacion import Operacion
from Optimizador.OptimizadorValorImplicito.Asignacion import Asignacion
from Optimizador.OptimizadorValorImplicito.Conversion import Conversion
from Optimizador.OptimizadorValorImplicito.Operacion import TIPO_OPERACION
from Optimizador.OptimizadorValorImplicito.Primitivo import Primitivo
from Optimizador.OptimizadorValorImplicito.AccesoLista import AccesoLista
from Optimizador.OptimizadorValorImplicito.Read import Read
from Optimizador.OptimizadorPrimitivas.Imprimir import Imprimir
from Optimizador.OptimizadorPrimitivas.Unset import Unset
from Optimizador.OptimizadorPrimitivas.Exit import Exit
...
def p_if(t):
    'if_instruccion : IF PARIZQ expresion PARDER GOTO ID PTCOMA'
...
def p_error(t):
    try:
        print(" Error sintactico, no se esperaba el valor "+t.value,t.lineno,find_column(t)) 
    except:
        print(" Error sintactico, no se esperaba el valor "+t) 
